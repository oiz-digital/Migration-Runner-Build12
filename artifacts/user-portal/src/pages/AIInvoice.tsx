          ...
          <div style={{
            ...
            <div className="relative flex items-start justify-between gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 leading-relaxed mt-1 max-w-[260px]">{exchange.address}</p>
                <div className="flex flex-wrap gap-x-4 gap-y-0.5 mt-2">
                  <p className="text-[10px] text-slate-600 font-mono">GSTIN: <span className="text-slate-400">{exchange.gst}</span></p>
              ...
              <div className="text-right shrink-0">
                ...
                {/* ROI badge */}
                <div className="mt-2.5 inline-flex items-center gap-1.5 rounded-xl px-3 py-1.5"
                  style={{
          ...
          <div className="bg-white relative">
            ...
            <div style={{
              ...
              <span style={{
                ...
                fontSize: 72, fontWeight: 900, color: "rgba(139,92,246,0.04)",
            ...
            {/* Timeline strip */}
            <div className="relative px-8 py-4 grid grid-cols-3 gap-4"
            ...
            {/* ROI bar visual */}
            <div className="relative px-8 pt-5 pb-4" style={{ borderBottom: "2px solid #f1f5f9" }}>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="w-1 h-5 rounded-full" style={{ background: "linear-gradient(180deg,#8B5CF6,#6D28D9)" }} />
                  <p className="text-[10px] uppercase tracking-[0.12em] font-bold" style={{ color: "#6D28D9" }}>
                ...
                <table className="w-full text-xs">
                  ...
                  <tfoot>
                    <tr style={{ borderTop: "2px solid #7C3AED", background: "linear-gradient(135deg,#faf5ff,#f5f3ff)" }}>
                      ...
                      <td className="text-right px-4 py-3 font-extrabold text-violet-700 font-mono tabular-nums">
                        {fmtU(totals.payoutUsdt)} USDT
                      </td>
                      <td className="text-right px-4 py-3 font-bold text-violet-600 font-mono tabular-nums">
            ...
            {/* Stats bar */}
            <div className="relative px-8 py-5" style={{ borderBottom: "2px solid #f1f5f9", background: "#fafafa" }}>
              <div className="grid grid-cols-3 gap-3">
                {[
                  { label: "ROI", value: (isProfit ? "+" : "") + totals.roiPct.toFixed(2) + "%", color: roiColor,
                    bg: isProfit ? "#F0FDF4" : "#FEF2F2", border: isProfit ? "#BBF7D0" : "#FECACA" },
